...
nohup java  -Dfile.encoding=utf-8 -javaagent:/usr/local/mugu_blog/apache-skywalking-apm-bin-es7/agent/skywalking-agent.jar -Dskywalking.agent.service_name=blog-gateway -Dskywalking.collector.backend_service=47.111.0.135:8854 -jar -Xms200m -Xmx200m blog-gateway.jar &
...
nohup java  -Dfile.encoding=utf-8 -javaagent:/usr/local/mugu_blog/apache-skywalking-apm-bin-es7/agent/skywalking-agent.jar -Dskywalking.agent.service_name=blog-article -Dskywalking.collector.backend_service=47.111.0.135:8854 -jar -Xms200m -Xmx500m blog-article.jar &
